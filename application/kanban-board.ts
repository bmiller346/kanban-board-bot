...
export class KanbanBoard {
  constructor(
    private _backlog = new KanbanBoard.InnerColumn('Backlog'),
   ...
   * Getters
   */
  public get backlog(): Kanban.Board.Column {
    return this._backlog;
  }
  public get inProgress(): Kanban.Board.Column {
    return this._inProgress;
  }
  public get complete(): Kanban.Board.Column {
   ...
   */
  public removeFromBacklog(task: Task): void {
    this._backlog.remove(task);
  }
  public removeFromInProgress(task: Task): void {
    this._inProgress.remove(task);
  }
  public removeFromComplete(task: Task): void {
